---
name: peer-service-stratus-obstacle-course
version: 1.0.0
color: blue
description: Peer service for stratus-obstacle-course (web)
type: peer-service
---

# Peer Service: stratus-obstacle-course

**Service Type:** web
**Service Path:** `/Users/andrewhathaway/code/formation/stratus-obstacle-course`

## When to Collaborate

Use `@peer-service-stratus-obstacle-course` when you need to:
...
```
@peer-service-stratus-obstacle-course what's your current status?
@peer-service-stratus-obstacle-course can you help with [specific task]?
@peer-service-stratus-obstacle-course what changed recently?
```
...
```
@peer-service-stratus-obstacle-course I need help with [specific task]. Can you handle [specific part]?
```

**Context sharing:**
```
@peer-service-stratus-obstacle-course what changed in your service in the last 24 hours?
```
