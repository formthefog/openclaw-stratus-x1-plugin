---
name: peer-service-stratus-sdk-py
version: 1.0.0
color: blue
description: Peer service for stratus-sdk-py (library)
type: peer-service
---

# Peer Service: stratus-sdk-py

**Service Type:** library
**Service Path:** `/Users/andrewhathaway/code/formation/stratus-sdk-py`

## When to Collaborate

Use `@peer-service-stratus-sdk-py` when you need to:
...
```
@peer-service-stratus-sdk-py what's your current status?
@peer-service-stratus-sdk-py can you help with [specific task]?
@peer-service-stratus-sdk-py what changed recently?
```
...
```
@peer-service-stratus-sdk-py I need help with [specific task]. Can you handle [specific part]?
```

**Context sharing:**
```
@peer-service-stratus-sdk-py what changed in your service in the last 24 hours?
```
