---
name: peer-service-stratus-docs
version: 1.0.0
color: blue
description: Peer service for stratus-docs (web)
type: peer-service
---

# Peer Service: stratus-docs

**Service Type:** web
**Service Path:** `/Users/andrewhathaway/code/formation/stratus-docs`

## When to Collaborate

Use `@peer-service-stratus-docs` when you need to:
...
```
@peer-service-stratus-docs what's your current status?
@peer-service-stratus-docs can you help with [specific task]?
@peer-service-stratus-docs what changed recently?
```
...
```
@peer-service-stratus-docs I need help with [specific task]. Can you handle [specific part]?
```

**Context sharing:**
```
@peer-service-stratus-docs what changed in your service in the last 24 hours?
```
