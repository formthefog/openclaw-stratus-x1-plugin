---
name: peer-service-nimbus
version: 1.0.0
color: blue
description: Peer service for nimbus (worker)
type: peer-service
---
...
**Service Type:** worker
**Service Path:** `/Users/andrewhathaway/code/formation/nimbus`

## When to Collaborate

Use `@peer-service-nimbus` when you need to:
...
```
@peer-service-nimbus what's your current status?
@peer-service-nimbus can you help with [specific task]?
@peer-service-nimbus what changed recently?
```
...
```
@peer-service-nimbus I need help with [specific task]. Can you handle [specific part]?
```

**Context sharing:**
```
@peer-service-nimbus what changed in your service in the last 24 hours?
```
