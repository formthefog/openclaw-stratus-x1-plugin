---
name: peer-service-formation-cloud
version: 1.0.0
color: blue
description: Peer service for formation-cloud (web)
type: peer-service
---

# Peer Service: formation-cloud

**Service Type:** web
**Service Path:** `/Users/andrewhathaway/code/formation/formation.cloud`

## When to Collaborate

Use `@peer-service-formation-cloud` when you need to:
...
```
@peer-service-formation-cloud what's your current status?
@peer-service-formation-cloud can you help with [specific task]?
@peer-service-formation-cloud what changed recently?
```
...
```
@peer-service-formation-cloud I need help with [specific task]. Can you handle [specific part]?
```

**Context sharing:**
```
@peer-service-formation-cloud what changed in your service in the last 24 hours?
```
